package com.example.khedr;

import com.example.khedr.exceptions.*;
...
public class Network {
    ...
    public BaseStation getBaseStation() {
        for (Node n : nodes)
            if (n.getClass().getName().equals("com.example.khedr.BaseStation"))
                return (BaseStation) n;

        return null;
    }

    public void removeNode(com.example.khedr.Node node) throws NodeNotFoundException {
        if (nodes.contains(node)) {
